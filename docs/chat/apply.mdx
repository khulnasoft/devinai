...
<Info>
    Read more about how we built instant apply in our [blog
    post](https://devinai.khulnasoft.com/blog/instant-apply).
</Info>

Devinai's `Apply` allows you to quickly integrate a codeblock suggestion from the chat into your code.
