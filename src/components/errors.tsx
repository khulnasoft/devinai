...
import { signInDevinai, upgradeDevinai } from '../features/tools/toolSlice'
            ...
            >
                <div className="errorPopup">
                    ...
                    <div className="signup__body">
                        <div className="signup__title">Devinai</div>
                        <div className="signup__module">
                            ...
                            <div
                                ...
                                onClick={() => dispatch(signInDevinai(null))}
                            >
                                Log in
                            </div>
            ...
            >
                <div className="errorPopup">
                    ...
                    <div className="signup__body">
                        ...
                        <div className="signup__module">
                            <div className="signup__subtitle">
                                If you've enjoyed using Devinai, please consider
                                subscribing to one of our paid plans
                            </div>
                            <div
                                className="signup__signup_button"
                                onClick={() => dispatch(upgradeDevinai(null))}
                            >
                                Upgrade
                            </div>
                        </div>
