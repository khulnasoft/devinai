                            ...
                            className={`${
                                settings.useOpenAIKey
                                    ...
                                    : 'bg-red-500'
                                            ...
                                            mt-2 relative inline-flex h-[25px] w-[52px] shrink-0 devinai-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
                        >
...
export function OpenAIPanel() {
    ...
    return (
        <div className="settings__item">
            ...
            <div className="settings__item_description">
                You can enter an OpenAI API key to use Devinai at-cost
            </div>
            <div className="flex">
                <input
                    className={`settings__item_textarea
                            ...
                            className={`${
                                settings.useOpenAIKey
                                    ...
                                    : 'bg-red-500'
                                            ...
                                            mt-2 relative inline-flex h-[24px] w-[52px] shrink-0 devinai-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
                        >
                            <span className="sr-only">Use setting</span>
                            <span
                                aria-hidden="true"
...
export function DevinaiLogin({
    ...
    const signIn = useCallback(() => {
        dispatch(signInDevinai(null))
    }, [])
    const signOut = useCallback(() => {
        dispatch(signOutDevinai(null))
    }, [])

    const upgrade = useCallback(() => {
        dispatch(upgradeDevinai(null))
    }, [])
    ...
    if (!signedIn) {
        currentPanel = (
            <div className="settings__item">
                <div className="settings__item_title">Devinai Account</div>
                <div className="settings__item_description">
        ...
        if (proVersion) {
            ...
            currentPanel = (
                <>
                    ...
                    <div className="settings__item">
                        <div className="settings__item_title">Devinai Pro</div>
                        <div className="settings__item_description">
