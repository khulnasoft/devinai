...
Specifically, it includes...
 ...
 - [drop devinai](https://codemirror.net/6/docs/ref/#view.dropDevinai)
 ...
 - [rectangular selection](https://codemirror.net/6/docs/ref/#view.rectangularSelection) and [crosshair devinai](https://codemirror.net/6/docs/ref/#view.crosshairDevinai)
...
export const basicSetup = (options: BasicSetupOptions = {}): Extension[] => {
    ...
    if (options.dropDevinai !== false) extensions.push(dropDevinai())
    ...
    if (options.crosshairDevinai !== false) extensions.push(crosshairDevinai())
