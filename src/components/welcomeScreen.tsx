                            ...
                            <div className="inline-block" key={plan.name}>
                                <RadioGroup.Option
                                  ...
                                  ${checked ? 'checked-welcome-radio' : ''}
                                    relative flex welcome-radio devinai-pointer rounded-md px-3 py-3 welcome-radio-butotn mr-2 shadow-md outline-none`
                                    }
                                >
                                    {({ active, checked }) => (
                                        <>
        ...
        <div className="welcome-screen-container">
            <div className="welcome-screen-inner">
                ...
                <div className="copilot-setup-section section">
                    ...
                    <p className="key-bindings-subheading subheading">
                        Devinai comes with a built-in Github Copilot
                        integration.
                    </p>
                    <CopilotPanel />
                </div>
