export const API_ROOT = 'https://aidevinai.com'
export const HOMEPAGE_ROOT = 'https://khulnasoft.com'
...
export class AuthRateLimitError extends ExpectedBackendError {
    constructor(
        message = "It seems like you're making an unusual number of AI requests. Please try again later. If you think this is a mistake, please contact admin@khulnasoft.com"
    ) {
        super(message)
...
export class NoAuthGlobalOldRateLimitError extends ExpectedBackendError {
    constructor(
        message = "If you've enjoyed using Devinai, please consider subscribing to one of our paid plans. Otherwise, you can enter your Open AI key (gear icon) to continue using the AI features at-cost."
    ) {
        super(message)
...
export class NoAuthGlobalNewRateLimitError extends ExpectedBackendError {
    constructor(
        message = "We're currently experiencing a high volume of requests. Please try again in a few minutes. For support, please contact admin@khulnasoft.com."
    ) {
        super(message)
